...
parser = argparse.ArgumentParser(description="Generate 3d co-ordinate of the ball from ball_info.csv")
# Add the file name argument
parser.add_argument("file", type=str, help="Path to the csv folder")
